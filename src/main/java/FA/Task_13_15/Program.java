...
public class Program {
    ...
    public static void addAnimal() {
        try {
            ...
            String commands;
            try {
                date_of_birth = format.parse(scn.nextLine());
            ...
            if (i == 1) {
                ...
                switch (x) {
                    case 1:
                        cat.add(new Cat(name, date_of_birth, commands));
                        break;
                    case 2:
                        dog.add(new Dog(name, date_of_birth, commands));
                        break;
                    case 3:
                        hamster.add(new Hamster(name, date_of_birth, commands));
                        break;
                    default:
                        break;
                }
                ...
                switch (y) {
                    case 1:
                        horse.add(new Horse(name, date_of_birth, commands));
                        break;
                    case 2:
                        camel.add(new Camel(name, date_of_birth, commands));
                        break;
                    case 3:
                        donkey.add(new Donkey(name, date_of_birth, commands));
                        break;
                    default:
                        break;
                }
            }
            if ((Objects.equals(name, "")) || (Objects.equals(date_of_birth, new Date(0))) || (i > 2)) {
            ...
            case 1: {
                ...
                switch (i) {
                    case 1:
                        ...
                        cat.get(n - 1).setCommands(scn.nextLine());
                        break;
                    case 2:
                        for (Dog dog : dog) {
                        ...
                        n = Integer.parseInt(scn.nextLine());
                        System.out.print("Введите новые команды животного: ");
                        dog.get(n - 1).setCommands(scn.nextLine());
                        break;
                    case 3:
                        ...
                        n = Integer.parseInt(scn.nextLine());
                        System.out.print("Введите новые команды животного: ");
                        hamster.get(n - 1).setCommands(scn.nextLine());
                        break;
                    default:
                        break;
                }
            ...
            case 2: {
                ...
                switch (i) {
                    case 1:
                        ...
                        n = Integer.parseInt(scn.nextLine());
                        System.out.print("Введите новые команды животного: ");
                        horse.get(n - 1).setCommands(scn.nextLine());
                        break;
                    case 2:
                        for (Camel camel : camel) {
                        ...
                        n = Integer.parseInt(scn.nextLine());
                        System.out.print("Введите новые команды животного: ");
                        camel.get(n - 1).setCommands(scn.nextLine());
                        break;
                    case 3:
                        for (Donkey donkey : donkey) {
                        ...
                        n = Integer.parseInt(scn.nextLine());
                        System.out.print("Введите новые команды животного: ");
                        donkey.get(n - 1).setCommands(scn.nextLine());
                        break;
                    default:
                        break;
                }
